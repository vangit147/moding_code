...
#define picture_page 1351 //从1351扇区开始存储，每张图片占picture_cap大小
#define info_pic_name	info_page*4096+500 //从这里开始存储图片名字 每个图片名字长度为20B
#define low_network_wifi_picture_page 1282		//存储低电压图片 1282~1341

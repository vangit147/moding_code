...
/**************************************************/
void ncolor_display(uint16_t index,unsigned char pic_data4)
{
...
//		Acep_loadPIC2(pic_ncolor_1);
		...
		printf("in ncolor_display index=0\n");
		Acep_loadPIC1_init();
		Acep_loadPIC1_TEST(pic_data4,134400);
		Acep_loadPIC1_end();
		printf("screen 1 done\n");
		Acep_loadPIC2_init();
		Acep_loadPIC2_TEST(pic_data4,134400);
		Acep_loadPIC2_end();
		printf("screen 2 done\n");
	}
}
